...
public class EncryptEx_02 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // 시스템 환경변수중에 callor.com 변수의 값을 추출(getter) 하여 salt 변수에 담는다
        ...
        scan.close();
        System.out.println("Properties 파일 생성 완료료");
    }
}
